const players = [
  ...
  function displayPlayers(param) {
      ...
      param.forEach((elem ,index) => {
          if (elem.position=="GK") {
              ...
              suggestedPlayers.innerHTML +=`<div onclick="addSubstitutes(${index})" class="relative h-[100px] w-[90px] md:h-[140px] md:w-[110px] lg:h-[180px] lg:w-[150px]">
              <div class="absolute  inset-0"> <img class="h-full w-full" src="./images/gold84.png" alt=""></div>
  ...
  function removeSubstitutes(index) {
    ...
    removePlayer(players , substitutes[index] )
    displaySubstitutes(); 
  }
